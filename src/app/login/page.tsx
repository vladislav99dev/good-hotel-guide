        ...
        <section className="flex">
            <div className="w-1/2 px-52 py-32">
                ...
                <form onSubmit={handleSubmit} className="bg-[#FAFAFA] flex flex-col p-10 gap-y-6 relative">
                    ...
                    />
                    <button disabled={(formData.email.value.length > 0 && formData.password.value.length) ? false : true} className={`Gibson-Regular py-3 bg-[#EEEEEE] text-[#9E9E9E]  ${formData.email.value.length > 0 && formData.password.value.length > 0 && "!bg-custom-purple text-white"}`} type="submit">LOG IN</button>
